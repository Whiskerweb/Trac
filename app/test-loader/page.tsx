...
export default function TestLoaderPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-12 bg-white p-8">
      <h1 className="text-2xl font-bold">Logo Comparison</h1>

      {/* Side-by-side comparison: reference logo vs SVG */}
