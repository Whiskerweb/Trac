...
import { Upload, Check, ChevronRight, CheckCircle2, Youtube, Globe, Loader2, User, Settings, LogOut, Eye, EyeOff, AlertTriangle, X, CreditCard, ExternalLink, Unlink, RefreshCw, AlertCircle, CheckCircle, Clock, FileText, Briefcase, MapPin, Sparkles } from 'lucide-react'
...
export default function SettingsPage() {
    ...
    useEffect(() => {
        if (activeTab === 'account' && !stripeAccount && !loadingStripe) loadStripeInfo()
    }, [activeTab])
        ...
        <div className="min-h-screen bg-[#FAFAFA]">
            <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                ...
                <motion.div
                    ...
                    className="flex gap-1 p-1 bg-neutral-100 rounded-xl mb-8 w-fit"
                >
                    {[
                        ...
                        <button
                            ...
                            className={`relative flex items-center gap-2 px-4 py-2.5 rounded-lg text-[14px] font-medium transition-all duration-200 ${
                                activeTab === tab.id
                                    ? 'text-neutral-900'
                ...
                <AnimatePresence>
                    {activeTab === 'profile' && (hasChanges || saving || saveSuccess) && (
                        <motion.div
