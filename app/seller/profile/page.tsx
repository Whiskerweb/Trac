...
import { Upload, Check, X, ChevronUp, ChevronDown, CheckCircle2, Circle, Youtube, Globe, Loader2 } from 'lucide-react'
        ...
        <div className="min-h-screen bg-[#FAFAFA]">
            <div className="max-w-3xl mx-auto px-8 py-10">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                    ...
                    <p className="text-xs text-gray-600 mb-4">
                        Select your main activity type to help startups better identify you.
                    </p>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                    ...
                    <p className="text-xs text-gray-600 mb-4">
                        Share your portfolio and resume to help startups understand your experience and expertise.
                    </p>
                    ...
                    <div className="mb-6">
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">Link to your portfolio website or case studies</p>
                    </div>
                            ...
                            <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-200 border-dashed rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                ...
                                {uploadingCv ? (
                                    ...
                                    <>
                                        ...
                                        <p className="text-sm text-gray-600 mb-1">Click to upload CV</p>
                ...
                <div className="flex justify-end">
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="px-5 py-2.5 bg-black text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
